...
const Created: React.FC = () => {
  ...
  const handleNavigateToPointIpMap = useCallback(() => {
    navigation.navigate('PointIpMap', {
      latitude,
      longitude,
      latitudeDelta: 0.01,
      longitudeDelta: 0.01,
  ...
  return (
    <Container>
      ...
      <Body>
        ...
        <SuccessText>Ponto IP criado com sucesso!</SuccessText>

        <BackButton onPress={handleNavigateToPointIpMap}>
