...
const SelectLocation: React.FC = () => {
  ...
  const handleNavigateToSearchLocation = useCallback(() => {
    navigation.navigate('RoundNotificationSearchLocation');
  }, [navigation]);

  const handleNavigateToSearchPlatelet = useCallback(() => {
    navigation.navigate('RoundNotificationSearchPlatelet');
  }, [navigation]);

  const handleNavigateToSelectTypeAndImage = useCallback(() => {
    navigation.navigate('RoundNotificationSelectTypeAndImage', {
      address,
      district,
      city,
      latitude,
